...
namespace TestDAL
{
    public class OperateBES
    {
        ...
        public TestData CompareMacAddress(TestData data)
        {
            try
            {
                int[] numbers = Array.ConvertAll(data.Other.Split(';'), int.Parse);
                ...
                if (numbers.Length == 2)
                {
                    mac1 = TestItmes[numbers[0] - 1].Value;
                    mac2 = TestItmes[numbers[1] - 1].Value;
                ...
                else
                {
                    mac1 = TestItmes[numbers[0] - 1].Value;
                    mac2 = TestItmes[numbers[1] - 1].Value;
                    mac3 = TestItmes[numbers[2] - 1].Value;
                    mac4 = TestItmes[numbers[3] - 1].Value;
                    //mac1 = "B49A95B5FE80";
                    //mac2 = "B49A95B5FE80";
                    //mac3 = "B49A95B60A32";
                    //mac4 = "B49A95B5FE80";
