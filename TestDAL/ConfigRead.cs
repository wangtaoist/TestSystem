   ...
   public  class ConfigRead
    {
        public static List<InitTestItem> GetInitTestItem()
        {
            ...
            list.Add(new InitTestItem()
            {
                TestItem = "GetSingleSensitivity_LostPack",
                Remark = "获取耳机相应频道灵敏度丢失包的数量"
            });
            list.Add(new InitTestItem()
            {
            ...
            list.Add(new InitTestItem()
            {
                TestItem = "DUT_GetCarrierMod992M",
                Remark = "获取耳机ECM(EVM)99% 2M数据，设置其他参数栏位:Freq:\"相应的频率\""
            });
            list.Add(new InitTestItem()
            {
                TestItem = "DUT_GetCarrierMod993M",
                Remark = "获取耳机ECM(EVM)99% 3M数据，设置其他参数栏位:Freq:\"相应的频率\""
            });
            list.Add(new InitTestItem()
            {
                TestItem = "GetModulationindexF1Avg",
                Remark = "获取耳机调制指数F1的平均值"
            });
            list.Add(new InitTestItem()
            {
                TestItem = "GetModulationindexF2Max",
                Remark = "获取耳机调制指数F2的最大值，需要先测试GetModulationindexF1Avg"
            });
            list.Add(new InitTestItem()
            {
                TestItem = "GetModulationindexF2F1",
                Remark = "获取耳机调制指数F2/F1的绝对值，需要先测试GetModulationindexF1Avg"
            });
            list.Add(new InitTestItem()
            {
            ...
            list.Add(new InitTestItem()
            {
                ...
                Remark = "通用串口指令(byte数据类型)，数据格式:指令;跳过几个byte;第几位byte是数据长度,偏移位数;编码方式：ASCII/16/10/bt/voltage/average;是否有返回;发送指令后等待时间返回;命令格式：ASCII/BYTE" +
                "例如：55 AA FF 17 00 A5;5;3,2;16;true;1000" +
                ";如果读取蓝牙地址时打开MES，请将项目名称一定要带蓝牙地址字样"
            });
            list.Add(new InitTestItem()
            {
            ...
            list.Add(new InitTestItem()
            {
                TestItem = "EnterProductLineTestModeRealMe",
                Remark = "RealMe项目充电盒进入产线测试模式，在其他配置里面输入发送指令后读取的时间和每次指令后的延迟时间，例如：100;200"
            });
            list.Add(new InitTestItem()
            {
            ...
            list.Add(new InitTestItem()
            {
                TestItem = "InitializeAndOpenHid",
                Remark = "初始化和打开HID，在其他配置里面输入VID，如：12d1"
            });
            list.Add(new InitTestItem()
            {
                TestItem = "HW296WriteSN",
                Remark = "写入SN"
            });
            list.Add(new InitTestItem()
            {
                TestItem = "HW296ReadSN",
                Remark = "读取SN"
            });
            list.Add(new InitTestItem()
            {
                TestItem = "HIDSendByteCommend",
                Remark = "发送HID指令(byte数据类型)，数据格式:指令; 跳过几个byte; 第几位byte是数据长度,偏移位数; 编码方式：ASCII / 16 / 10 / bt / voltage; 是否有返回; 命令格式：ASCII / BYTE" +
                "例如：55 AA FF 17 00 A5;5;3,2;16;true;BYTE"
            });
            list.Add(new InitTestItem()
            {
                TestItem = "HW296ReadHW",
                Remark = "读取版本"
            });
            list.Add(new InitTestItem()
            {
            ...
            list.Add(new InitTestItem()
            {
                TestItem = "ModbusOpenAndConnect",
                Remark = "打开和连接Modbus，在其他配置中输入波特率"
            });
            list.Add(new InitTestItem()
            {
                TestItem = "ModbusWriteSingleCoil",
                Remark = "写入bool类型值，在其他配置中输入地址"
            });
            list.Add(new InitTestItem()
            {
                TestItem = "ModbusGetRunStatus",
                Remark = "获取设备运行状态，在其他配置中输入地址"
            });
            list.Add(new InitTestItem()
            {
                TestItem = "ModbusReadFloatDefinition",
                Remark = "获取float值，在其他配置中输入地址"
            });
            list.Add(new InitTestItem()
            {
                TestItem = "ModbusClosed",
                Remark = "关闭和释放Modbus资源"
            });
